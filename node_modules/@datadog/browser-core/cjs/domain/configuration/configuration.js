...
exports.buildCookieOptions = exports.buildConfiguration = exports.DEFAULT_CONFIGURATION = exports.DefaultPrivacyLevel = void 0;
...
exports.DEFAULT_CONFIGURATION = {
    ...
    defaultPrivacyLevel: exports.DefaultPrivacyLevel.MASK_USER_INPUT,
    /**
...
function buildConfiguration(initConfiguration, buildEnv) {
    ...
    if (utils_1.objectHasValue(exports.DefaultPrivacyLevel, initConfiguration.defaultPrivacyLevel)) {
