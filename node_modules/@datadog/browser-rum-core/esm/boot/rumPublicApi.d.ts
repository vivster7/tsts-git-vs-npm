import { Context, InitConfiguration, Configuration, InternalMonitoring, DefaultPrivacyLevel } from '@datadog/browser-core';
...
export declare type StartRum<C extends RumInitConfiguration = RumInitConfiguration> = (initConfiguration: C, configuration: Configuration, internalMonitoring: InternalMonitoring, getCommonContext: () => CommonContext, recorderApi: RecorderApi, initialViewName?: string) => StartRumResult;
