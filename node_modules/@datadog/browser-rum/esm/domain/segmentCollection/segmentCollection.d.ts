...
export declare function startSegmentCollection(lifeCycle: LifeCycle, applicationId: string, session: RumSession, parentContexts: ParentContexts, send: (data: Uint8Array, meta: SegmentMeta, rawSegmentSize: number, flushReason?: string) => void, worker: DeflateWorker): {
