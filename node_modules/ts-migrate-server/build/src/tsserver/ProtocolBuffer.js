...
const BACKSLASH_R = Buffer.from('\r', 'utf8')[0];
const BACKSLASH_N = Buffer.from('\n', 'utf8')[0];
class ProtocolBuffer {
    constructor() {
        this.index = 0;
        this.buffer = Buffer.allocUnsafe(DEFAULT_SIZE);
    }
    append(data) {
        let toAppend = null;
...
exports.default = ProtocolBuffer;
//# sourceMappingURL=ProtocolBuffer.js.map