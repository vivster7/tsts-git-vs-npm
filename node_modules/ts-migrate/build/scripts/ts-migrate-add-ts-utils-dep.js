...
if (!projectJsonConfig.internalDependencies ||
    ...
    fs.writeFileSync(projectJsonPath, writer.toSource({ quote: 'double', trailingComma: false, quoteKeys: true }), 'utf-8');
}
//# sourceMappingURL=ts-migrate-add-ts-utils-dep.js.map